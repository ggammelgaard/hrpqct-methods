#!/usr/bin/env python3
""" EXP_11 INDEX 0-4 HNH Config B1
32	Softmax		DL		(1,1)   IDX 0
33	Softmax		DL		(1,1)   IDX 1
34	Softmax		DL		(1,1)   IDX 2
35	Softmax		DL		(1,1)   IDX 3
36	Softmax		DL		(1,1)   IDX 4
"""
import os
import sys
import datetime
...
if __name__ == '__main__':
    ...
    mconfig["label_weights"] = (1.00, 1.00)
    mconfig["labels"] = (0, 1)
