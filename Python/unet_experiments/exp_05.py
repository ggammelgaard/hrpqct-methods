#!/usr/bin/env python3
""" EXP_05 INDEX 1-4 Config A3
15	Softmax		CE		(1,1,1,1)   IDX 1
16	Softmax		CE		(1,1,1,1)   IDX 2
17	Softmax		CE		(1,1,1,1)   IDX 3
18	Softmax		CE		(1,1,1,1)   IDX 4
"""
import os
import sys
import datetime
