#!/usr/bin/env python3
""" EXP_02 INDEX 0
5	Sigmoid		DL		w_Frequency		Permute     # Config A5
6	Softmax		DL		w_Frequency		Permute     # Config A6
7	Softmax		CE		w_Frequency		Permute     # Config A7
w_Frequency = (1, 1, 5, 5.85)
"""
import os
import sys
import datetime
...
if __name__ == '__main__':
    ...
    mconfig["label_weights"] = (1, 1, 5, 5.85)
    ...
    settings_dict = dict()
    settings_dict["activation"] = ('sigmoid', 'softmax', 'softmax')
    settings_dict["loss"] = ('dl', 'dl', 'ce',)
