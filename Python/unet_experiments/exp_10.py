#!/usr/bin/env python3
""" EXP_10 INDEX 1-4 Config A5
37	Sigmoid		DL		w_Frequency   IDX 1
38	Sigmoid		DL		w_Frequency   IDX 2
39	Sigmoid		DL		w_Frequency   IDX 3
40	Sigmoid		DL		w_Frequency   IDX 4
...
if __name__ == '__main__':
    ...
    mconfig["activation"] = 'sigmoid'  # 'sigmoid' or 'softmax'
