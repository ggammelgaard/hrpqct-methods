#!/usr/bin/env python3
""" EXP_08 INDEX 0-4 HNH Config B??=A10
27	Softmax		CE		w_Area   IDX 0
28	Softmax		CE		w_Area   IDX 1
29	Softmax		CE		w_Area   IDX 2
30	Softmax		CE		w_Area   IDX 3
31	Softmax		CE		w_Area   IDX 4
w_Area = (1.00, 2002.01)
"""
import os
import sys
...
if __name__ == '__main__':
    ...
    mconfig["label_weights"] = (1.00, 2002.01)
    mconfig["labels"] = (0, 1)
