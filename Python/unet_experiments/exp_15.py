#!/usr/bin/env python3
""" EXP_15 INDEX 0-4 HNH Config B3
50	Softmax		CE		w_Frequency   IDX 0
51	Softmax		CE		w_Frequency   IDX 1
52	Softmax		CE		w_Frequency   IDX 2
53	Softmax		CE		w_Frequency   IDX 3
54	Softmax		CE		w_Frequency   IDX 4
