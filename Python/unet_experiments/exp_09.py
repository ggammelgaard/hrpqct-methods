#!/usr/bin/env python3
""" EXP_09 INDEX 0-4 HNH Config B4
32	Softmax		DL		w_Area   IDX 0
33	Softmax		DL		w_Area   IDX 1
34	Softmax		DL		w_Area   IDX 2
35	Softmax		DL		w_Area   IDX 3
36	Softmax		DL		w_Area   IDX 4
w_Area = (1.00, 2002.01)
"""
import os
import sys
