#!/usr/bin/env python3
""" EXP_02 INDEX 0
07	3D-ResNet	Softmax		Adam            lr=27e-6    IDX 0   # Config C7
08	3D-ResNet	Sigmoid		Adam            lr=27e-6    IDX 0   # Config C8
09	3D-ResNet	Softmax		SGD_nesterov    lr=1e-3     IDX 0   # Config C9
10	3D-ResNet	Sigmoid		SGD_nesterov    lr=1e-3     IDX 0   # Config C10
11	3D-ResNet	Softmax		SGD_momentum    lr=1e-6     IDX 0   # Config C11
12	3D-ResNet	Sigmoid		SGD_momentum    lr=1e-6     IDX 0   # Config C12
"""
import os
import sys
import datetime
